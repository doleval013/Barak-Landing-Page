...
- Name: landing.spec.ts >> responsive checks 375x812 >> page uses white-blue palette and correct heading text
- Location: tests\landing.spec.ts:37:9
...
Locator: locator('h1')
Expected substring: "ברק אלוני סדנאות כלבנות והעצמה"
Received string:    "ברק אלוני - סדנאות כלבנות והעצמה"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('h1')
    14 × locator resolved to <h1>ברק אלוני - סדנאות כלבנות והעצמה</h1>
       - unexpected value "ברק אלוני - סדנאות כלבנות והעצמה"

```

```yaml
- heading "ברק אלוני - סדנאות כלבנות והעצמה" [level=1]
```
